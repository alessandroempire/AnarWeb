...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DimensionPiedra.alto'
        db.alter_column('anarapp_dimensionpiedra', 'alto', self.gf('anarapp.models.CharField')(max_length=65000, null=True))

        # Changing field 'DimensionPiedra.ancho'
        db.alter_column('anarapp_dimensionpiedra', 'ancho', self.gf('anarapp.models.CharField')(max_length=65000, null=True))

        # Changing field 'DimensionPiedra.largo'
        db.alter_column('anarapp_dimensionpiedra', 'largo', self.gf('anarapp.models.CharField')(max_length=65000, null=True))

    def backwards(self, orm):

        # Changing field 'DimensionPiedra.alto'
        db.alter_column('anarapp_dimensionpiedra', 'alto', self.gf('django.db.models.fields.DecimalField')(default='', max_digits=12, decimal_places=6))

        # Changing field 'DimensionPiedra.ancho'
        db.alter_column('anarapp_dimensionpiedra', 'ancho', self.gf('django.db.models.fields.DecimalField')(default='', max_digits=12, decimal_places=6))

        # Changing field 'DimensionPiedra.largo'
        db.alter_column('anarapp_dimensionpiedra', 'largo', self.gf('django.db.models.fields.DecimalField')(default='', max_digits=12, decimal_places=6))
    ...
    models = {
        ...
        'anarapp.dimensionpiedra': {
            ...
            'alto': ('anarapp.models.CharField', [], {'max_length': '65000', 'null': 'True', 'blank': 'True'}),
            'ancho': ('anarapp.models.CharField', [], {'max_length': '65000', 'null': 'True', 'blank': 'True'}),
            'dimensiones': ('anarapp.models.CharField', [], {'max_length': '65000'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'largo': ('anarapp.models.CharField', [], {'max_length': '65000', 'null': 'True', 'blank': 'True'}),
