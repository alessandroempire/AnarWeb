...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BibYacimiento.archivo1'
        db.add_column('anarapp_bibyacimiento', 'archivo1',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibYacimiento.archivo2'
        db.add_column('anarapp_bibyacimiento', 'archivo2',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibYacimiento.archivo3'
        db.add_column('anarapp_bibyacimiento', 'archivo3',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibYacimiento.archivo4'
        db.add_column('anarapp_bibyacimiento', 'archivo4',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibYacimiento.tieneFotografia1'
        db.add_column('anarapp_bibyacimiento', 'tieneFotografia1',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibYacimiento.tieneFotografia2'
        db.add_column('anarapp_bibyacimiento', 'tieneFotografia2',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibYacimiento.tieneFotografia3'
        db.add_column('anarapp_bibyacimiento', 'tieneFotografia3',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibYacimiento.tieneFotografia4'
        db.add_column('anarapp_bibyacimiento', 'tieneFotografia4',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'BibYacimiento.tieneFotografia'
        db.alter_column('anarapp_bibyacimiento', 'tieneFotografia', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'BibYacimiento.archivo'
        db.alter_column('anarapp_bibyacimiento', 'archivo', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
        # Adding field 'BibPiedra.archivo1'
        db.add_column('anarapp_bibpiedra', 'archivo1',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibPiedra.archivo2'
        db.add_column('anarapp_bibpiedra', 'archivo2',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibPiedra.archivo3'
        db.add_column('anarapp_bibpiedra', 'archivo3',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibPiedra.archivo4'
        db.add_column('anarapp_bibpiedra', 'archivo4',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'BibPiedra.archivo'
        db.alter_column('anarapp_bibpiedra', 'archivo', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting field 'BibYacimiento.archivo1'
        db.delete_column('anarapp_bibyacimiento', 'archivo1')

        # Deleting field 'BibYacimiento.archivo2'
        db.delete_column('anarapp_bibyacimiento', 'archivo2')

        # Deleting field 'BibYacimiento.archivo3'
        db.delete_column('anarapp_bibyacimiento', 'archivo3')

        # Deleting field 'BibYacimiento.archivo4'
        db.delete_column('anarapp_bibyacimiento', 'archivo4')

        # Deleting field 'BibYacimiento.tieneFotografia1'
        db.delete_column('anarapp_bibyacimiento', 'tieneFotografia1')

        # Deleting field 'BibYacimiento.tieneFotografia2'
        db.delete_column('anarapp_bibyacimiento', 'tieneFotografia2')

        # Deleting field 'BibYacimiento.tieneFotografia3'
        db.delete_column('anarapp_bibyacimiento', 'tieneFotografia3')

        # Deleting field 'BibYacimiento.tieneFotografia4'
        db.delete_column('anarapp_bibyacimiento', 'tieneFotografia4')


        # Changing field 'BibYacimiento.tieneFotografia'
        db.alter_column('anarapp_bibyacimiento', 'tieneFotografia', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'BibYacimiento.archivo'
        db.alter_column('anarapp_bibyacimiento', 'archivo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
        # Deleting field 'BibPiedra.archivo1'
        db.delete_column('anarapp_bibpiedra', 'archivo1')

        # Deleting field 'BibPiedra.archivo2'
        db.delete_column('anarapp_bibpiedra', 'archivo2')

        # Deleting field 'BibPiedra.archivo3'
        db.delete_column('anarapp_bibpiedra', 'archivo3')

        # Deleting field 'BibPiedra.archivo4'
        db.delete_column('anarapp_bibpiedra', 'archivo4')


        # Changing field 'BibPiedra.archivo'
        db.alter_column('anarapp_bibpiedra', 'archivo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
