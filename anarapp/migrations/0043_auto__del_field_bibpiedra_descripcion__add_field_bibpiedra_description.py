...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BibPiedra.descripcion'
        db.delete_column('anarapp_bibpiedra', 'descripcion')

        # Adding field 'BibPiedra.description'
        db.add_column('anarapp_bibpiedra', 'description',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BibPiedra.tieneMapa'
        db.add_column('anarapp_bibpiedra', 'tieneMapa',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibPiedra.tieneMapa1'
        db.add_column('anarapp_bibpiedra', 'tieneMapa1',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibPiedra.tieneMapa2'
        db.add_column('anarapp_bibpiedra', 'tieneMapa2',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibPiedra.tieneMapa3'
        db.add_column('anarapp_bibpiedra', 'tieneMapa3',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibPiedra.tieneMapa4'
        db.add_column('anarapp_bibpiedra', 'tieneMapa4',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BibPiedra.descripcion'
        db.add_column('anarapp_bibpiedra', 'descripcion',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Deleting field 'BibPiedra.description'
        db.delete_column('anarapp_bibpiedra', 'description')

        # Deleting field 'BibPiedra.tieneMapa'
        db.delete_column('anarapp_bibpiedra', 'tieneMapa')

        # Deleting field 'BibPiedra.tieneMapa1'
        db.delete_column('anarapp_bibpiedra', 'tieneMapa1')

        # Deleting field 'BibPiedra.tieneMapa2'
        db.delete_column('anarapp_bibpiedra', 'tieneMapa2')

        # Deleting field 'BibPiedra.tieneMapa3'
        db.delete_column('anarapp_bibpiedra', 'tieneMapa3')

        # Deleting field 'BibPiedra.tieneMapa4'
        db.delete_column('anarapp_bibpiedra', 'tieneMapa4')
