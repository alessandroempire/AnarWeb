...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Manifestaciones.crazy'
        db.add_column('anarapp_manifestaciones', 'crazy',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=120, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Manifestaciones.crazy'
        db.delete_column('anarapp_manifestaciones', 'crazy')
    ...
    models = {
        ...
        'anarapp.manifestaciones': {
            ...
            'crazy': ('django.db.models.fields.CharField', [], {'max_length': '120', 'blank': 'True'}),
