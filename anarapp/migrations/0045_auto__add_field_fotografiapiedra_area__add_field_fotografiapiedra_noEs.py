...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FotografiaPiedra.area'
        db.add_column('anarapp_fotografiapiedra', 'area',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FotografiaPiedra.noEsAerea'
        db.add_column('anarapp_fotografiapiedra', 'noEsAerea',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FotografiaPiedra.satelital'
        db.add_column('anarapp_fotografiapiedra', 'satelital',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FotografiaPiedra.fecha'
        db.add_column('anarapp_fotografiapiedra', 'fecha',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FotografiaPiedra.area'
        db.delete_column('anarapp_fotografiapiedra', 'area')

        # Deleting field 'FotografiaPiedra.noEsAerea'
        db.delete_column('anarapp_fotografiapiedra', 'noEsAerea')

        # Deleting field 'FotografiaPiedra.satelital'
        db.delete_column('anarapp_fotografiapiedra', 'satelital')

        # Deleting field 'FotografiaPiedra.fecha'
        db.delete_column('anarapp_fotografiapiedra', 'fecha')
    ...
    models = {
        ...
        'anarapp.fotografiapiedra': {
            ...
            'archivo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'area': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'fecha': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
