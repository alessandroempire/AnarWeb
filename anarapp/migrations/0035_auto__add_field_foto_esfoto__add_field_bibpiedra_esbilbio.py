...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Foto.esfoto'
        db.add_column('anarapp_foto', 'esfoto',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BibPiedra.esbilbio'
        db.add_column('anarapp_bibpiedra', 'esbilbio',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Foto.esfoto'
        db.delete_column('anarapp_foto', 'esfoto')

        # Deleting field 'BibPiedra.esbilbio'
        db.delete_column('anarapp_bibpiedra', 'esbilbio')
