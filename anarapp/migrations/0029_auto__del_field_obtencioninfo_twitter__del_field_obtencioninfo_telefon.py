...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ObtencionInfo.twitter'
        db.delete_column('anarapp_obtencioninfo', 'twitter')

        # Deleting field 'ObtencionInfo.telefonoCel'
        db.delete_column('anarapp_obtencioninfo', 'telefonoCel')

        # Deleting field 'ObtencionInfo.mail'
        db.delete_column('anarapp_obtencioninfo', 'mail')

        # Deleting field 'ObtencionInfo.paginaWeb'
        db.delete_column('anarapp_obtencioninfo', 'paginaWeb')

        # Deleting field 'ObtencionInfo.verificado'
        db.delete_column('anarapp_obtencioninfo', 'verificado')

        # Deleting field 'ObtencionInfo.comunicacion'
        db.delete_column('anarapp_obtencioninfo', 'comunicacion')

        # Deleting field 'ObtencionInfo.telefono'
        db.delete_column('anarapp_obtencioninfo', 'telefono')

        # Deleting field 'ObtencionInfo.fecha'
        db.delete_column('anarapp_obtencioninfo', 'fecha')

        # Deleting field 'ObtencionInfo.direccion'
        db.delete_column('anarapp_obtencioninfo', 'direccion')

        # Deleting field 'ObtencionInfo.blog'
        db.delete_column('anarapp_obtencioninfo', 'blog')

        # Deleting field 'ObtencionInfo.nombre'
        db.delete_column('anarapp_obtencioninfo', 'nombre')

        # Deleting field 'ObtencionInfo.prospeccion'
        db.delete_column('anarapp_obtencioninfo', 'prospeccion')

        # Deleting field 'ObtencionInfo.nombreFacebook'
        db.delete_column('anarapp_obtencioninfo', 'nombreFacebook')

        # Adding field 'ObtInfoYac.isinfo'
        db.add_column('anarapp_obtinfoyac', 'isinfo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ObtInfoYac.prospeccionY'
        db.add_column('anarapp_obtinfoyac', 'prospeccionY',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ObtInfoYac.comunicacionY'
        db.add_column('anarapp_obtinfoyac', 'comunicacionY',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ObtInfoYac.nombreY'
        db.add_column('anarapp_obtinfoyac', 'nombreY',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'ObtInfoYac.direccionY'
        db.add_column('anarapp_obtinfoyac', 'direccionY',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'ObtInfoYac.telefonoY'
        db.add_column('anarapp_obtinfoyac', 'telefonoY',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'ObtInfoYac.telefonoCelY'
        db.add_column('anarapp_obtinfoyac', 'telefonoCelY',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'ObtInfoYac.mailY'
        db.add_column('anarapp_obtinfoyac', 'mailY',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)

        # Adding field 'ObtInfoYac.paginaWebY'
        db.add_column('anarapp_obtinfoyac', 'paginaWebY',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'ObtInfoYac.twitterY'
        db.add_column('anarapp_obtinfoyac', 'twitterY',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'ObtInfoYac.nombreFacebookY'
        db.add_column('anarapp_obtinfoyac', 'nombreFacebookY',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'ObtInfoYac.blogY'
        db.add_column('anarapp_obtinfoyac', 'blogY',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'ObtInfoYac.fechaY'
        db.add_column('anarapp_obtinfoyac', 'fechaY',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ObtInfoYac.verificadoY'
        db.add_column('anarapp_obtinfoyac', 'verificadoY',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ObtInfoPiedra.isinfo'
        db.add_column('anarapp_obtinfopiedra', 'isinfo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ObtInfoPiedra.prospeccionP'
        db.add_column('anarapp_obtinfopiedra', 'prospeccionP',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ObtInfoPiedra.comunicacionP'
        db.add_column('anarapp_obtinfopiedra', 'comunicacionP',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ObtInfoPiedra.nombreP'
        db.add_column('anarapp_obtinfopiedra', 'nombreP',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'ObtInfoPiedra.direccionP'
        db.add_column('anarapp_obtinfopiedra', 'direccionP',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'ObtInfoPiedra.telefonoP'
        db.add_column('anarapp_obtinfopiedra', 'telefonoP',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'ObtInfoPiedra.telefonoCelP'
        db.add_column('anarapp_obtinfopiedra', 'telefonoCelP',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'ObtInfoPiedra.mailP'
        db.add_column('anarapp_obtinfopiedra', 'mailP',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)

        # Adding field 'ObtInfoPiedra.paginaWebP'
        db.add_column('anarapp_obtinfopiedra', 'paginaWebP',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'ObtInfoPiedra.twitterP'
        db.add_column('anarapp_obtinfopiedra', 'twitterP',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'ObtInfoPiedra.nombreFacebookP'
        db.add_column('anarapp_obtinfopiedra', 'nombreFacebookP',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'ObtInfoPiedra.blogP'
        db.add_column('anarapp_obtinfopiedra', 'blogP',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'ObtInfoPiedra.fechaP'
        db.add_column('anarapp_obtinfopiedra', 'fechaP',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ObtInfoPiedra.verificadoP'
        db.add_column('anarapp_obtinfopiedra', 'verificadoP',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ObtencionInfo.twitter'
        db.add_column('anarapp_obtencioninfo', 'twitter',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'ObtencionInfo.telefonoCel'
        db.add_column('anarapp_obtencioninfo', 'telefonoCel',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'ObtencionInfo.mail'
        db.add_column('anarapp_obtencioninfo', 'mail',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)

        # Adding field 'ObtencionInfo.paginaWeb'
        db.add_column('anarapp_obtencioninfo', 'paginaWeb',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'ObtencionInfo.verificado'
        db.add_column('anarapp_obtencioninfo', 'verificado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ObtencionInfo.comunicacion'
        db.add_column('anarapp_obtencioninfo', 'comunicacion',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ObtencionInfo.telefono'
        db.add_column('anarapp_obtencioninfo', 'telefono',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'ObtencionInfo.fecha'
        db.add_column('anarapp_obtencioninfo', 'fecha',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ObtencionInfo.direccion'
        db.add_column('anarapp_obtencioninfo', 'direccion',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'ObtencionInfo.blog'
        db.add_column('anarapp_obtencioninfo', 'blog',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'ObtencionInfo.nombre'
        db.add_column('anarapp_obtencioninfo', 'nombre',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'ObtencionInfo.prospeccion'
        db.add_column('anarapp_obtencioninfo', 'prospeccion',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ObtencionInfo.nombreFacebook'
        db.add_column('anarapp_obtencioninfo', 'nombreFacebook',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Deleting field 'ObtInfoYac.isinfo'
        db.delete_column('anarapp_obtinfoyac', 'isinfo')

        # Deleting field 'ObtInfoYac.prospeccionY'
        db.delete_column('anarapp_obtinfoyac', 'prospeccionY')

        # Deleting field 'ObtInfoYac.comunicacionY'
        db.delete_column('anarapp_obtinfoyac', 'comunicacionY')

        # Deleting field 'ObtInfoYac.nombreY'
        db.delete_column('anarapp_obtinfoyac', 'nombreY')

        # Deleting field 'ObtInfoYac.direccionY'
        db.delete_column('anarapp_obtinfoyac', 'direccionY')

        # Deleting field 'ObtInfoYac.telefonoY'
        db.delete_column('anarapp_obtinfoyac', 'telefonoY')

        # Deleting field 'ObtInfoYac.telefonoCelY'
        db.delete_column('anarapp_obtinfoyac', 'telefonoCelY')

        # Deleting field 'ObtInfoYac.mailY'
        db.delete_column('anarapp_obtinfoyac', 'mailY')

        # Deleting field 'ObtInfoYac.paginaWebY'
        db.delete_column('anarapp_obtinfoyac', 'paginaWebY')

        # Deleting field 'ObtInfoYac.twitterY'
        db.delete_column('anarapp_obtinfoyac', 'twitterY')

        # Deleting field 'ObtInfoYac.nombreFacebookY'
        db.delete_column('anarapp_obtinfoyac', 'nombreFacebookY')

        # Deleting field 'ObtInfoYac.blogY'
        db.delete_column('anarapp_obtinfoyac', 'blogY')

        # Deleting field 'ObtInfoYac.fechaY'
        db.delete_column('anarapp_obtinfoyac', 'fechaY')

        # Deleting field 'ObtInfoYac.verificadoY'
        db.delete_column('anarapp_obtinfoyac', 'verificadoY')

        # Deleting field 'ObtInfoPiedra.isinfo'
        db.delete_column('anarapp_obtinfopiedra', 'isinfo')

        # Deleting field 'ObtInfoPiedra.prospeccionP'
        db.delete_column('anarapp_obtinfopiedra', 'prospeccionP')

        # Deleting field 'ObtInfoPiedra.comunicacionP'
        db.delete_column('anarapp_obtinfopiedra', 'comunicacionP')

        # Deleting field 'ObtInfoPiedra.nombreP'
        db.delete_column('anarapp_obtinfopiedra', 'nombreP')

        # Deleting field 'ObtInfoPiedra.direccionP'
        db.delete_column('anarapp_obtinfopiedra', 'direccionP')

        # Deleting field 'ObtInfoPiedra.telefonoP'
        db.delete_column('anarapp_obtinfopiedra', 'telefonoP')

        # Deleting field 'ObtInfoPiedra.telefonoCelP'
        db.delete_column('anarapp_obtinfopiedra', 'telefonoCelP')

        # Deleting field 'ObtInfoPiedra.mailP'
        db.delete_column('anarapp_obtinfopiedra', 'mailP')

        # Deleting field 'ObtInfoPiedra.paginaWebP'
        db.delete_column('anarapp_obtinfopiedra', 'paginaWebP')

        # Deleting field 'ObtInfoPiedra.twitterP'
        db.delete_column('anarapp_obtinfopiedra', 'twitterP')

        # Deleting field 'ObtInfoPiedra.nombreFacebookP'
        db.delete_column('anarapp_obtinfopiedra', 'nombreFacebookP')

        # Deleting field 'ObtInfoPiedra.blogP'
        db.delete_column('anarapp_obtinfopiedra', 'blogP')

        # Deleting field 'ObtInfoPiedra.fechaP'
        db.delete_column('anarapp_obtinfopiedra', 'fechaP')

        # Deleting field 'ObtInfoPiedra.verificadoP'
        db.delete_column('anarapp_obtinfopiedra', 'verificadoP')
    ...
    models = {
        ...
        'anarapp.bibyacimiento': {
            ...
            'escolor': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'institucion': ('anarapp.models.CharField', [], {'max_length': '65000', 'blank': 'True'}),
            'tieneFotografia': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'tieneMapa': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'tipoMapa': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'titulo': ('anarapp.models.CharField', [], {'max_length': '65000', 'blank': 'True'}),
        ...
        'anarapp.obtinfopiedra': {
            ...
            'nombreP': ('anarapp.models.CharField', [], {'max_length': '65000'}),
        ...
        'anarapp.peliculapiedra': {
            ...
            'numCopiay': ('django.db.models.fields.IntegerField', [], {}),
