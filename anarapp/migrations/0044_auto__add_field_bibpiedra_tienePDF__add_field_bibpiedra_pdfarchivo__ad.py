...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BibPiedra.tienePDF'
        db.add_column('anarapp_bibpiedra', 'tienePDF',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BibPiedra.pdfarchivo'
        db.add_column('anarapp_bibpiedra', 'pdfarchivo',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibPiedra.pdfarchivo1'
        db.add_column('anarapp_bibpiedra', 'pdfarchivo1',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibPiedra.pdfarchivo2'
        db.add_column('anarapp_bibpiedra', 'pdfarchivo2',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibPiedra.tieneWord'
        db.add_column('anarapp_bibpiedra', 'tieneWord',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BibPiedra.wordarchivo'
        db.add_column('anarapp_bibpiedra', 'wordarchivo',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibPiedra.wordarchivo1'
        db.add_column('anarapp_bibpiedra', 'wordarchivo1',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BibPiedra.tienePDF'
        db.delete_column('anarapp_bibpiedra', 'tienePDF')

        # Deleting field 'BibPiedra.pdfarchivo'
        db.delete_column('anarapp_bibpiedra', 'pdfarchivo')

        # Deleting field 'BibPiedra.pdfarchivo1'
        db.delete_column('anarapp_bibpiedra', 'pdfarchivo1')

        # Deleting field 'BibPiedra.pdfarchivo2'
        db.delete_column('anarapp_bibpiedra', 'pdfarchivo2')

        # Deleting field 'BibPiedra.tieneWord'
        db.delete_column('anarapp_bibpiedra', 'tieneWord')

        # Deleting field 'BibPiedra.wordarchivo'
        db.delete_column('anarapp_bibpiedra', 'wordarchivo')

        # Deleting field 'BibPiedra.wordarchivo1'
        db.delete_column('anarapp_bibpiedra', 'wordarchivo1')
