...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('anarapp_dimensionpiedra', 'alto', self.gf('anarapp.models.CharField')(default='', max_length=65000))

        # Changing field 'DimensionPiedra.ancho'
        db.alter_column('anarapp_dimensionpiedra', 'ancho', self.gf('anarapp.models.CharField')(default='', max_length=65000))

        # Changing field 'DimensionPiedra.largo'
        db.alter_column('anarapp_dimensionpiedra', 'largo', self.gf('anarapp.models.CharField')(default='', max_length=65000))
