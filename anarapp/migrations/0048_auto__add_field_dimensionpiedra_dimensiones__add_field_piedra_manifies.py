...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DimensionPiedra.dimensiones'
        db.add_column('anarapp_dimensionpiedra', 'dimensiones',
        ...
        # Deleting field 'CaraTrabajada.alto'
        db.delete_column('anarapp_caratrabajada', 'alto')

        # Deleting field 'CaraTrabajada.ancho'
        db.delete_column('anarapp_caratrabajada', 'ancho')

        # Deleting field 'CaraTrabajada.largo'
        db.delete_column('anarapp_caratrabajada', 'largo')


    def backwards(self, orm):
        # Deleting field 'DimensionPiedra.dimensiones'
        db.delete_column('anarapp_dimensionpiedra', 'dimensiones')

        # Deleting field 'Piedra.manifiestacionAsociada'
        db.delete_column('anarapp_piedra', 'manifiestacionAsociada')

        # Adding field 'CaraTrabajada.alto'
        db.add_column('anarapp_caratrabajada', 'alto',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=3),
                      keep_default=False)

        # Adding field 'CaraTrabajada.ancho'
        db.add_column('anarapp_caratrabajada', 'ancho',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=3),
                      keep_default=False)

        # Adding field 'CaraTrabajada.largo'
        db.add_column('anarapp_caratrabajada', 'largo',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=3),
                      keep_default=False)
