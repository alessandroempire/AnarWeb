...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EscRedPiedra.esEscNatPiedra'
        db.add_column('anarapp_escredpiedra', 'esEscNatPiedra',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EscRedPiedra.numPiezasP'
        db.add_column('anarapp_escredpiedra', 'numPiezasP',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'EscRedPiedra.institutoP'
        db.add_column('anarapp_escredpiedra', 'institutoP',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'EscRedPiedra.personaP'
        db.add_column('anarapp_escredpiedra', 'personaP',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'EscNatPiedra.esEscNatPiedra'
        db.add_column('anarapp_escnatpiedra', 'esEscNatPiedra',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EscNatPiedra.numPiezasP'
        db.add_column('anarapp_escnatpiedra', 'numPiezasP',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'EscNatPiedra.institutoP'
        db.add_column('anarapp_escnatpiedra', 'institutoP',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'EscNatPiedra.personaP'
        db.add_column('anarapp_escnatpiedra', 'personaP',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Deleting field 'RepGrafPiedra.instituto'
        db.delete_column('anarapp_repgrafpiedra', 'instituto')

        # Deleting field 'RepGrafPiedra.persona'
        db.delete_column('anarapp_repgrafpiedra', 'persona')

        # Deleting field 'RepGrafPiedra.numPiezas'
        db.delete_column('anarapp_repgrafpiedra', 'numPiezas')


    def backwards(self, orm):
        # Deleting field 'EscRedPiedra.esEscNatPiedra'
        db.delete_column('anarapp_escredpiedra', 'esEscNatPiedra')

        # Deleting field 'EscRedPiedra.numPiezasP'
        db.delete_column('anarapp_escredpiedra', 'numPiezasP')

        # Deleting field 'EscRedPiedra.institutoP'
        db.delete_column('anarapp_escredpiedra', 'institutoP')

        # Deleting field 'EscRedPiedra.personaP'
        db.delete_column('anarapp_escredpiedra', 'personaP')

        # Deleting field 'EscNatPiedra.esEscNatPiedra'
        db.delete_column('anarapp_escnatpiedra', 'esEscNatPiedra')

        # Deleting field 'EscNatPiedra.numPiezasP'
        db.delete_column('anarapp_escnatpiedra', 'numPiezasP')

        # Deleting field 'EscNatPiedra.institutoP'
        db.delete_column('anarapp_escnatpiedra', 'institutoP')

        # Deleting field 'EscNatPiedra.personaP'
        db.delete_column('anarapp_escnatpiedra', 'personaP')

        # Adding field 'RepGrafPiedra.instituto'
        db.add_column('anarapp_repgrafpiedra', 'instituto',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'RepGrafPiedra.persona'
        db.add_column('anarapp_repgrafpiedra', 'persona',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'RepGrafPiedra.numPiezas'
        db.add_column('anarapp_repgrafpiedra', 'numPiezas',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
