...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BibYacimiento.descripcion'
        db.delete_column('anarapp_bibyacimiento', 'descripcion')

        # Adding field 'BibYacimiento.description'
        db.add_column('anarapp_bibyacimiento', 'description',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BibYacimiento.descripcion'
        db.add_column('anarapp_bibyacimiento', 'descripcion',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Deleting field 'BibYacimiento.description'
        db.delete_column('anarapp_bibyacimiento', 'description')
