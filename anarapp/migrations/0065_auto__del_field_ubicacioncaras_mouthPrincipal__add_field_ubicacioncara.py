...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UbicacionCaras.principalMouth'
        db.add_column('anarapp_ubicacioncaras', 'principalMouth',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UbicacionCaras.principalMouth'
        db.delete_column('anarapp_ubicacioncaras', 'principalMouth')
