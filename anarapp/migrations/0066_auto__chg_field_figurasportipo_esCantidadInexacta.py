...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FigurasPorTipo.esCantidadInexacta'
        db.alter_column('anarapp_figurasportipo', 'esCantidadInexacta', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'FigurasPorTipo.esCantidadInexacta'
        db.alter_column('anarapp_figurasportipo', 'esCantidadInexacta', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        'anarapp.figurasportipo': {
            ...
            'esCantidadInexacta': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'numero': ('anarapp.models.CharField', [], {'max_length': '65000'}),
