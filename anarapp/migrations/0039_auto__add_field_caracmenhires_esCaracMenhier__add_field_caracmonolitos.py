...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CaracMenhires.esCaracMenhier'
        db.add_column('anarapp_caracmenhires', 'esCaracMenhier',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CaracMonolitos.esCarcaMonolitos'
        db.add_column('anarapp_caracmonolitos', 'esCarcaMonolitos',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CaracDolmenArt.esCaracDolmen'
        db.add_column('anarapp_caracdolmenart', 'esCaracDolmen',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CaracMenhires.esCaracMenhier'
        db.delete_column('anarapp_caracmenhires', 'esCaracMenhier')

        # Deleting field 'CaracMonolitos.esCarcaMonolitos'
        db.delete_column('anarapp_caracmonolitos', 'esCarcaMonolitos')

        # Deleting field 'CaracDolmenArt.esCaracDolmen'
        db.delete_column('anarapp_caracdolmenart', 'esCaracDolmen')
