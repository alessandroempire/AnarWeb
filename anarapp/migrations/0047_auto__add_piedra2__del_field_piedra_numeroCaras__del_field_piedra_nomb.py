...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('anarapp_piedra2', (
            ...
            ('nombreFiguras', self.gf('anarapp.models.CharField')(max_length=65000)),
        ...
        # Deleting field 'Piedra.numeroCaras'
        db.delete_column('anarapp_piedra', 'numeroCaras')

        # Deleting field 'Piedra.nombreFiguras'
        db.delete_column('anarapp_piedra', 'nombreFiguras')

        # Deleting field 'Piedra.numeroCarasTrajabadas'
        db.delete_column('anarapp_piedra', 'numeroCarasTrajabadas')

        # Deleting field 'Piedra.estado'
        db.delete_column('anarapp_piedra', 'estado_id')

        # Deleting field 'Piedra.manifiestacionAsociada'
        db.delete_column('anarapp_piedra', 'manifiestacionAsociada')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Piedra.numeroCaras'
        db.add_column('anarapp_piedra', 'numeroCaras',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Piedra.nombreFiguras'
        db.add_column('anarapp_piedra', 'nombreFiguras',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'Piedra.numeroCarasTrajabadas'
        db.add_column('anarapp_piedra', 'numeroCarasTrajabadas',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Piedra.estado'
        db.add_column('anarapp_piedra', 'estado',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='EstadoPied', null=True, to=orm['anarapp.Estado'], blank=True),
                      keep_default=False)

        # Adding field 'Piedra.manifiestacionAsociada'
        db.add_column('anarapp_piedra', 'manifiestacionAsociada',
