...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UbicacionCaras.luminosidad'
        db.delete_column('anarapp_ubicacioncaras', 'luminosidad')

        # Deleting field 'UbicacionCaras.bocaPrincipal'
        db.delete_column('anarapp_ubicacioncaras', 'bocaPrincipal')

        # Deleting field 'UbicacionCaras.altura'
        db.delete_column('anarapp_ubicacioncaras', 'altura')

        # Adding field 'UbicacionCaras.mouthPrincipal'
        db.add_column('anarapp_ubicacioncaras', 'mouthPrincipal',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=6, blank=True),
                      keep_default=False)

        # Adding field 'UbicacionCaras.luminosity'
        db.add_column('anarapp_ubicacioncaras', 'luminosity',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UbicacionCaras.height'
        db.add_column('anarapp_ubicacioncaras', 'height',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=3, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UbicacionCaras.luminosidad'
        db.add_column('anarapp_ubicacioncaras', 'luminosidad',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'UbicacionCaras.bocaPrincipal'
        db.add_column('anarapp_ubicacioncaras', 'bocaPrincipal',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=6),
                      keep_default=False)

        # Adding field 'UbicacionCaras.altura'
        db.add_column('anarapp_ubicacioncaras', 'altura',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=3),
                      keep_default=False)

        # Deleting field 'UbicacionCaras.mouthPrincipal'
        db.delete_column('anarapp_ubicacioncaras', 'mouthPrincipal')

        # Deleting field 'UbicacionCaras.luminosity'
        db.delete_column('anarapp_ubicacioncaras', 'luminosity')

        # Deleting field 'UbicacionCaras.height'
        db.delete_column('anarapp_ubicacioncaras', 'height')
    ...
    models = {
        ...
        'anarapp.ubicacioncaras': {
            ...
            'height': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '6', 'decimal_places': '3', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'mouthPrincipal': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '6', 'blank': 'True'}),
