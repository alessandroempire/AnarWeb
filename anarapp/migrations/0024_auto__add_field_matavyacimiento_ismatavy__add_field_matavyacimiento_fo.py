...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MatAVYacimiento.ismatavy'
        db.add_column('anarapp_matavyacimiento', 'ismatavy',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'MatAVYacimiento.format'
        db.add_column('anarapp_matavyacimiento', 'format',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'MatAVYacimiento.archive'
        db.add_column('anarapp_matavyacimiento', 'archive',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MatAVPiedra.ismatavy'
        db.add_column('anarapp_matavpiedra', 'ismatavy',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'MatAVPiedra.format'
        db.add_column('anarapp_matavpiedra', 'format',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'MatAVPiedra.archive'
        db.add_column('anarapp_matavpiedra', 'archive',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'MatAudioVisual.formato'
        db.delete_column('anarapp_mataudiovisual', 'formato')

        # Deleting field 'MatAudioVisual.archivo'
        db.delete_column('anarapp_mataudiovisual', 'archivo')


    def backwards(self, orm):
        # Deleting field 'MatAVYacimiento.ismatavy'
        db.delete_column('anarapp_matavyacimiento', 'ismatavy')

        # Deleting field 'MatAVYacimiento.format'
        db.delete_column('anarapp_matavyacimiento', 'format')

        # Deleting field 'MatAVYacimiento.archive'
        db.delete_column('anarapp_matavyacimiento', 'archive')

        # Deleting field 'MatAVPiedra.ismatavy'
        db.delete_column('anarapp_matavpiedra', 'ismatavy')

        # Deleting field 'MatAVPiedra.format'
        db.delete_column('anarapp_matavpiedra', 'format')

        # Deleting field 'MatAVPiedra.archive'
        db.delete_column('anarapp_matavpiedra', 'archive')

        # Adding field 'MatAudioVisual.formato'
        db.add_column('anarapp_mataudiovisual', 'formato',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'MatAudioVisual.archivo'
        db.add_column('anarapp_mataudiovisual', 'archivo',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)
