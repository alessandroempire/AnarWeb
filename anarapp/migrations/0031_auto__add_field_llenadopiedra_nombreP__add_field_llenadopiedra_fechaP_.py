...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LlenadoPiedra.nombreP'
        db.add_column('anarapp_llenadopiedra', 'nombreP',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'LlenadoPiedra.fechaP'
        db.add_column('anarapp_llenadopiedra', 'fechaP',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'LlenadoPor.nombre'
        db.delete_column('anarapp_llenadopor', 'nombre')

        # Deleting field 'LlenadoPor.fecha'
        db.delete_column('anarapp_llenadopor', 'fecha')

        # Adding field 'LlenadoYac.nombreY'
        db.add_column('anarapp_llenadoyac', 'nombreY',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'LlenadoYac.fechaY'
        db.add_column('anarapp_llenadoyac', 'fechaY',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LlenadoPiedra.nombreP'
        db.delete_column('anarapp_llenadopiedra', 'nombreP')

        # Deleting field 'LlenadoPiedra.fechaP'
        db.delete_column('anarapp_llenadopiedra', 'fechaP')

        # Adding field 'LlenadoPor.nombre'
        db.add_column('anarapp_llenadopor', 'nombre',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'LlenadoPor.fecha'
        db.add_column('anarapp_llenadopor', 'fecha',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'LlenadoYac.nombreY'
        db.delete_column('anarapp_llenadoyac', 'nombreY')

        # Deleting field 'LlenadoYac.fechaY'
        db.delete_column('anarapp_llenadoyac', 'fechaY')
