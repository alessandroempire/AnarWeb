...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BibYacimiento.tieneMapa'
        db.alter_column('anarapp_bibyacimiento', 'tieneMapa', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'BibYacimiento.tieneMapa1'
        db.alter_column('anarapp_bibyacimiento', 'tieneMapa1', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'BibYacimiento.tieneMapa2'
        db.alter_column('anarapp_bibyacimiento', 'tieneMapa2', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'BibYacimiento.tieneMapa3'
        db.alter_column('anarapp_bibyacimiento', 'tieneMapa3', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'BibYacimiento.tieneMapa4'
        db.alter_column('anarapp_bibyacimiento', 'tieneMapa4', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'BibYacimiento.tieneMapa'
        db.alter_column('anarapp_bibyacimiento', 'tieneMapa', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'BibYacimiento.tieneMapa1'
        db.alter_column('anarapp_bibyacimiento', 'tieneMapa1', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'BibYacimiento.tieneMapa2'
        db.alter_column('anarapp_bibyacimiento', 'tieneMapa2', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'BibYacimiento.tieneMapa3'
        db.alter_column('anarapp_bibyacimiento', 'tieneMapa3', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'BibYacimiento.tieneMapa4'
        db.alter_column('anarapp_bibyacimiento', 'tieneMapa4', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
