...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CaracSurcoAmoladores.esCaracSurcoAmoladores'
        db.add_column('anarapp_caracsurcoamoladores', 'esCaracSurcoAmoladores',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CaracSurcoMortero.esCaracSurcoMortero'
        db.add_column('anarapp_caracsurcomortero', 'esCaracSurcoMortero',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CaracSurcoCupulas.esCaracSurcoCupulas'
        db.add_column('anarapp_caracsurcocupulas', 'esCaracSurcoCupulas',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CaracSurcoBateas.esCaracSurcoBateas'
        db.add_column('anarapp_caracsurcobateas', 'esCaracSurcoBateas',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CaracSurcoPuntosAcopl.esCaracSurcPuntosAcopl'
        db.add_column('anarapp_caracsurcopuntosacopl', 'esCaracSurcPuntosAcopl',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CaracSurcoPetroglifo.esCaracSucorPetro'
        db.add_column('anarapp_caracsurcopetroglifo', 'esCaracSucorPetro',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CaracSurcoAmoladores.esCaracSurcoAmoladores'
        db.delete_column('anarapp_caracsurcoamoladores', 'esCaracSurcoAmoladores')

        # Deleting field 'CaracSurcoMortero.esCaracSurcoMortero'
        db.delete_column('anarapp_caracsurcomortero', 'esCaracSurcoMortero')

        # Deleting field 'CaracSurcoCupulas.esCaracSurcoCupulas'
        db.delete_column('anarapp_caracsurcocupulas', 'esCaracSurcoCupulas')

        # Deleting field 'CaracSurcoBateas.esCaracSurcoBateas'
        db.delete_column('anarapp_caracsurcobateas', 'esCaracSurcoBateas')

        # Deleting field 'CaracSurcoPuntosAcopl.esCaracSurcPuntosAcopl'
        db.delete_column('anarapp_caracsurcopuntosacopl', 'esCaracSurcPuntosAcopl')

        # Deleting field 'CaracSurcoPetroglifo.esCaracSucorPetro'
        db.delete_column('anarapp_caracsurcopetroglifo', 'esCaracSucorPetro')
