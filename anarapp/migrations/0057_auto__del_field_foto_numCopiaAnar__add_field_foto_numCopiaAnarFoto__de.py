...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Foto.numCopiaAnar'
        db.delete_column('anarapp_foto', 'numCopiaAnar')

        # Adding field 'Foto.numCopiaAnarFoto'
        db.add_column('anarapp_foto', 'numCopiaAnarFoto',
        ...
        # Adding field 'VideoYacimiento.numCopiayac'
        db.add_column('anarapp_videoyacimiento', 'numCopiayac',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'VideoPiedra.numCopiaP'
        db.delete_column('anarapp_videopiedra', 'numCopiaP')

        # Adding field 'VideoPiedra.numCopiaPiedra'
        db.add_column('anarapp_videopiedra', 'numCopiaPiedra',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'PeliYacimiento.numCopiayac'
        db.add_column('anarapp_peliyacimiento', 'numCopiayac',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'PeliculaPiedra.numCopiaPiedra'
        db.add_column('anarapp_peliculapiedra', 'numCopiaPiedra',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Foto.numCopiaAnar'
        db.add_column('anarapp_foto', 'numCopiaAnar',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Foto.numCopiaAnarFoto'
        db.delete_column('anarapp_foto', 'numCopiaAnarFoto')
        ...
        # Deleting field 'VideoYacimiento.numCopiayac'
        db.delete_column('anarapp_videoyacimiento', 'numCopiayac')

        # Adding field 'VideoPiedra.numCopiaP'
        db.add_column('anarapp_videopiedra', 'numCopiaP',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'VideoPiedra.numCopiaPiedra'
        db.delete_column('anarapp_videopiedra', 'numCopiaPiedra')
        ...
        # Deleting field 'PeliYacimiento.numCopiayac'
        db.delete_column('anarapp_peliyacimiento', 'numCopiayac')
        ...
        # Deleting field 'PeliculaPiedra.numCopiaPiedra'
        db.delete_column('anarapp_peliculapiedra', 'numCopiaPiedra')
    ...
    models = {
        ...
        'anarapp.manifestaciones': {
            ...
            'hasAmoladores': ('anarapp.models.CharField', [], {'max_length': '65000', 'blank': 'True'}),
            'hasCupulas': ('anarapp.models.CharField', [], {'max_length': '65000', 'blank': 'True'}),
            ...
            'hasPetroglifo': ('anarapp.models.CharField', [], {'max_length': '65000', 'blank': 'True'}),
            'hasPinturaRupestre': ('anarapp.models.CharField', [], {'max_length': '65000', 'blank': 'True'}),
            'hasPuntosAcoplados': ('anarapp.models.CharField', [], {'max_length': '65000', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
