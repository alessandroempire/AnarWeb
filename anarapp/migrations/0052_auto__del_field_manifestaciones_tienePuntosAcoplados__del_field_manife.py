...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Manifestaciones.tienePuntosAcoplados'
        db.delete_column('anarapp_manifestaciones', 'tienePuntosAcoplados')

        # Deleting field 'Manifestaciones.tieneCupulas'
        db.delete_column('anarapp_manifestaciones', 'tieneCupulas')

        # Deleting field 'Manifestaciones.tienePinturaRupestre'
        db.delete_column('anarapp_manifestaciones', 'tienePinturaRupestre')

        # Deleting field 'Manifestaciones.tieneAmoladores'
        db.delete_column('anarapp_manifestaciones', 'tieneAmoladores')

        # Deleting field 'Manifestaciones.tienePetroglifo'
        db.delete_column('anarapp_manifestaciones', 'tienePetroglifo')
        ...
        # Adding field 'Manifestaciones.hasMitos'
        db.add_column('anarapp_manifestaciones', 'hasMitos',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'Manifestaciones.hasOtros'
        db.add_column('anarapp_manifestaciones', 'hasOtros',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)


        # Changing field 'Piedra2.nombreFiguras'
        db.alter_column('anarapp_piedra2', 'nombreFiguras', self.gf('anarapp.models.CharField')(max_length=65000, null=True))

    def backwards(self, orm):
        # Adding field 'Manifestaciones.tienePuntosAcoplados'
        db.add_column('anarapp_manifestaciones', 'tienePuntosAcoplados',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Manifestaciones.tieneCupulas'
        db.add_column('anarapp_manifestaciones', 'tieneCupulas',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Manifestaciones.tienePinturaRupestre'
        db.add_column('anarapp_manifestaciones', 'tienePinturaRupestre',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Manifestaciones.tieneAmoladores'
        db.add_column('anarapp_manifestaciones', 'tieneAmoladores',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Manifestaciones.tienePetroglifo'
        db.add_column('anarapp_manifestaciones', 'tienePetroglifo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
        ...
        # Deleting field 'Manifestaciones.hasMitos'
        db.delete_column('anarapp_manifestaciones', 'hasMitos')

        # Deleting field 'Manifestaciones.hasOtros'
        db.delete_column('anarapp_manifestaciones', 'hasOtros')


        # Changing field 'Piedra2.nombreFiguras'
        db.alter_column('anarapp_piedra2', 'nombreFiguras', self.gf('anarapp.models.CharField')(default='', max_length=65000))
    ...
    models = {
        ...
        'anarapp.manifestaciones': {
            ...
            'hasAmoladores': ('anarapp.models.CharField', [], {'max_length': '65000'}),
            'hasCupulas': ('anarapp.models.CharField', [], {'max_length': '65000'}),
            'hasMitos': ('anarapp.models.CharField', [], {'max_length': '65000'}),
            'hasOtros': ('anarapp.models.CharField', [], {'max_length': '65000'}),
            'hasPetroglifo': ('anarapp.models.CharField', [], {'max_length': '65000'}),
            'hasPinturaRupestre': ('anarapp.models.CharField', [], {'max_length': '65000'}),
            'hasPuntosAcoplados': ('anarapp.models.CharField', [], {'max_length': '65000'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'anarapp.piedra2': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombreFiguras': ('anarapp.models.CharField', [], {'max_length': '65000', 'null': 'True', 'blank': 'True'}),
