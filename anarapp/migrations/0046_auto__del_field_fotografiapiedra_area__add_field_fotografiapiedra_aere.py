...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FotografiaPiedra.aerea'
        db.add_column('anarapp_fotografiapiedra', 'aerea',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'FotografiaPiedra.aerea'
        db.delete_column('anarapp_fotografiapiedra', 'aerea')
