...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaginaWebPiedra.tieneWb'
        db.add_column('anarapp_paginawebpiedra', 'tieneWb',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PaginaWebPiedra.direccionURLP'
        db.add_column('anarapp_paginawebpiedra', 'direccionURLP',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)

        # Deleting field 'PaginaWeb.direccionURL'
        db.delete_column('anarapp_paginaweb', 'direccionURL')

        # Adding field 'PaginaWebYac.tieneWb'
        db.add_column('anarapp_paginawebyac', 'tieneWb',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PaginaWebYac.direccionURLy'
        db.add_column('anarapp_paginawebyac', 'direccionURLy',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PaginaWebPiedra.tieneWb'
        db.delete_column('anarapp_paginawebpiedra', 'tieneWb')

        # Deleting field 'PaginaWebPiedra.direccionURLP'
        db.delete_column('anarapp_paginawebpiedra', 'direccionURLP')

        # Adding field 'PaginaWeb.direccionURL'
        db.add_column('anarapp_paginaweb', 'direccionURL',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)

        # Deleting field 'PaginaWebYac.tieneWb'
        db.delete_column('anarapp_paginawebyac', 'tieneWb')

        # Deleting field 'PaginaWebYac.direccionURLy'
        db.delete_column('anarapp_paginawebyac', 'direccionURLy')
