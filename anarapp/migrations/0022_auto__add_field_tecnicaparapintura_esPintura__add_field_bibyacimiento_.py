...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TecnicaParaPintura.esPintura'
        db.add_column('anarapp_tecnicaparapintura', 'esPintura',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BibYacimiento.esBibliografia'
        db.add_column('anarapp_bibyacimiento', 'esBibliografia',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'BibYacimiento.tieneFotografia'
        db.add_column('anarapp_bibyacimiento', 'tieneFotografia',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibYacimiento.tieneMapa'
        db.add_column('anarapp_bibyacimiento', 'tieneMapa',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'TecnicaParaPetroglifo.esPetroglifo'
        db.add_column('anarapp_tecnicaparapetroglifo', 'esPetroglifo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TecnicaParaGeoglifo.esGeoflifo'
        db.add_column('anarapp_tecnicaparageoglifo', 'esGeoflifo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TecnicaParaMicroPetro.esMicro'
        db.add_column('anarapp_tecnicaparamicropetro', 'esMicro',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TecnicaParaMonumentos.esMonumento'
        db.add_column('anarapp_tecnicaparamonumentos', 'esMonumento',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TecnicaParaPintura.esPintura'
        db.delete_column('anarapp_tecnicaparapintura', 'esPintura')

        # Deleting field 'BibYacimiento.esBibliografia'
        db.delete_column('anarapp_bibyacimiento', 'esBibliografia')

        # Deleting field 'BibYacimiento.tieneFotografia'
        db.delete_column('anarapp_bibyacimiento', 'tieneFotografia')

        # Deleting field 'BibYacimiento.tieneMapa'
        db.delete_column('anarapp_bibyacimiento', 'tieneMapa')

        # Deleting field 'TecnicaParaPetroglifo.esPetroglifo'
        db.delete_column('anarapp_tecnicaparapetroglifo', 'esPetroglifo')

        # Deleting field 'TecnicaParaGeoglifo.esGeoflifo'
        db.delete_column('anarapp_tecnicaparageoglifo', 'esGeoflifo')

        # Deleting field 'TecnicaParaMicroPetro.esMicro'
        db.delete_column('anarapp_tecnicaparamicropetro', 'esMicro')

        # Deleting field 'TecnicaParaMonumentos.esMonumento'
        db.delete_column('anarapp_tecnicaparamonumentos', 'esMonumento')
