...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EscNatPiedra.tipoReproduccion'
        db.delete_column('anarapp_escnatpiedra', 'tipoReproduccion')

        # Adding field 'EscNatPiedra.tipoReproduccione'
        db.add_column('anarapp_escnatpiedra', 'tipoReproduccione',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EscNatPiedra.tipoReproduccion'
        db.add_column('anarapp_escnatpiedra', 'tipoReproduccion',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'EscNatPiedra.tipoReproduccione'
        db.delete_column('anarapp_escnatpiedra', 'tipoReproduccione')
