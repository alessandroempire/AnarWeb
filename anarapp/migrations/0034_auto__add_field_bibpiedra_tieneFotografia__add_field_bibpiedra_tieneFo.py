...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BibPiedra.tieneFotografia'
        db.add_column('anarapp_bibpiedra', 'tieneFotografia',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibPiedra.tieneFotografia1'
        db.add_column('anarapp_bibpiedra', 'tieneFotografia1',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibPiedra.tieneFotografia2'
        db.add_column('anarapp_bibpiedra', 'tieneFotografia2',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibPiedra.tieneFotografia3'
        db.add_column('anarapp_bibpiedra', 'tieneFotografia3',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibPiedra.tieneFotografia4'
        db.add_column('anarapp_bibpiedra', 'tieneFotografia4',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BibPiedra.tieneFotografia'
        db.delete_column('anarapp_bibpiedra', 'tieneFotografia')

        # Deleting field 'BibPiedra.tieneFotografia1'
        db.delete_column('anarapp_bibpiedra', 'tieneFotografia1')

        # Deleting field 'BibPiedra.tieneFotografia2'
        db.delete_column('anarapp_bibpiedra', 'tieneFotografia2')

        # Deleting field 'BibPiedra.tieneFotografia3'
        db.delete_column('anarapp_bibpiedra', 'tieneFotografia3')

        # Deleting field 'BibPiedra.tieneFotografia4'
        db.delete_column('anarapp_bibpiedra', 'tieneFotografia4')
