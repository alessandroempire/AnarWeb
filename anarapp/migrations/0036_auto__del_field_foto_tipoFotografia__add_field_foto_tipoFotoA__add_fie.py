...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Foto.tipoFotografia'
        db.delete_column('anarapp_foto', 'tipoFotografia')

        # Adding field 'Foto.tipoFotoA'
        db.add_column('anarapp_foto', 'tipoFotoA',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Foto.tipoFotoNA'
        db.add_column('anarapp_foto', 'tipoFotoNA',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Foto.tipoFotoS'
        db.add_column('anarapp_foto', 'tipoFotoS',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Foto.tipoFotografia'
        db.add_column('anarapp_foto', 'tipoFotografia',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Foto.tipoFotoA'
        db.delete_column('anarapp_foto', 'tipoFotoA')

        # Deleting field 'Foto.tipoFotoNA'
        db.delete_column('anarapp_foto', 'tipoFotoNA')

        # Deleting field 'Foto.tipoFotoS'
        db.delete_column('anarapp_foto', 'tipoFotoS')
