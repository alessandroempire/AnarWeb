...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UbicacionCaras.heights'
        db.add_column('anarapp_ubicacioncaras', 'heights',
                      self.gf('anarapp.models.CharField')(max_length=65000, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UbicacionCaras.heights'
        db.delete_column('anarapp_ubicacioncaras', 'heights')
