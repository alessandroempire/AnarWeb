...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SupervisadoPor.nombre'
        db.delete_column('anarapp_supervisadopor', 'nombre')

        # Deleting field 'SupervisadoPor.fecha'
        db.delete_column('anarapp_supervisadopor', 'fecha')

        # Adding field 'SupervisadoYac.nombreY'
        db.add_column('anarapp_supervisadoyac', 'nombreY',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'SupervisadoYac.fechaY'
        db.add_column('anarapp_supervisadoyac', 'fechaY',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SupervisadoPiedra.nombreP'
        db.add_column('anarapp_supervisadopiedra', 'nombreP',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'SupervisadoPiedra.fechaP'
        db.add_column('anarapp_supervisadopiedra', 'fechaP',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SupervisadoPor.nombre'
        db.add_column('anarapp_supervisadopor', 'nombre',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'SupervisadoPor.fecha'
        db.add_column('anarapp_supervisadopor', 'fecha',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'SupervisadoYac.nombreY'
        db.delete_column('anarapp_supervisadoyac', 'nombreY')

        # Deleting field 'SupervisadoYac.fechaY'
        db.delete_column('anarapp_supervisadoyac', 'fechaY')

        # Deleting field 'SupervisadoPiedra.nombreP'
        db.delete_column('anarapp_supervisadopiedra', 'nombreP')

        # Deleting field 'SupervisadoPiedra.fechaP'
        db.delete_column('anarapp_supervisadopiedra', 'fechaP')
