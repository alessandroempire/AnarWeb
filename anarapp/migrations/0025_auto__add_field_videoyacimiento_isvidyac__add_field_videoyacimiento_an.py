...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoYacimiento.isvidyac'
        db.add_column('anarapp_videoyacimiento', 'isvidyac',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'VideoYacimiento.anioy'
        db.add_column('anarapp_videoyacimiento', 'anioy',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'VideoYacimiento.formatoy'
        db.add_column('anarapp_videoyacimiento', 'formatoy',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'VideoYacimiento.tituloy'
        db.add_column('anarapp_videoyacimiento', 'tituloy',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'VideoYacimiento.autory'
        db.add_column('anarapp_videoyacimiento', 'autory',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'VideoYacimiento.instituciony'
        db.add_column('anarapp_videoyacimiento', 'instituciony',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'VideoYacimiento.numReferenciay'
        db.add_column('anarapp_videoyacimiento', 'numReferenciay',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'VideoYacimiento.isFromAnary'
        db.add_column('anarapp_videoyacimiento', 'isFromAnary',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'VideoYacimiento.numCopiay'
        db.add_column('anarapp_videoyacimiento', 'numCopiay',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'VideoYacimiento.archivoy'
        db.add_column('anarapp_videoyacimiento', 'archivoy',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'VideoPiedra.isvidyac'
        db.add_column('anarapp_videopiedra', 'isvidyac',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'VideoPiedra.anioy'
        db.add_column('anarapp_videopiedra', 'anioy',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'VideoPiedra.formatoy'
        db.add_column('anarapp_videopiedra', 'formatoy',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'VideoPiedra.tituloy'
        db.add_column('anarapp_videopiedra', 'tituloy',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'VideoPiedra.autory'
        db.add_column('anarapp_videopiedra', 'autory',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'VideoPiedra.instituciony'
        db.add_column('anarapp_videopiedra', 'instituciony',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'VideoPiedra.numReferenciay'
        db.add_column('anarapp_videopiedra', 'numReferenciay',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'VideoPiedra.isFromAnary'
        db.add_column('anarapp_videopiedra', 'isFromAnary',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'VideoPiedra.numCopiay'
        db.add_column('anarapp_videopiedra', 'numCopiay',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'VideoPiedra.archivoy'
        db.add_column('anarapp_videopiedra', 'archivoy',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Video.anio'
        db.delete_column('anarapp_video', 'anio')

        # Deleting field 'Video.autor'
        db.delete_column('anarapp_video', 'autor')

        # Deleting field 'Video.numReferencia'
        db.delete_column('anarapp_video', 'numReferencia')

        # Deleting field 'Video.archivo'
        db.delete_column('anarapp_video', 'archivo')

        # Deleting field 'Video.institucion'
        db.delete_column('anarapp_video', 'institucion')

        # Deleting field 'Video.formato'
        db.delete_column('anarapp_video', 'formato')

        # Deleting field 'Video.isFromAnar'
        db.delete_column('anarapp_video', 'isFromAnar')

        # Deleting field 'Video.numCopia'
        db.delete_column('anarapp_video', 'numCopia')

        # Deleting field 'Video.titulo'
        db.delete_column('anarapp_video', 'titulo')


    def backwards(self, orm):
        # Deleting field 'VideoYacimiento.isvidyac'
        db.delete_column('anarapp_videoyacimiento', 'isvidyac')

        # Deleting field 'VideoYacimiento.anioy'
        db.delete_column('anarapp_videoyacimiento', 'anioy')

        # Deleting field 'VideoYacimiento.formatoy'
        db.delete_column('anarapp_videoyacimiento', 'formatoy')

        # Deleting field 'VideoYacimiento.tituloy'
        db.delete_column('anarapp_videoyacimiento', 'tituloy')

        # Deleting field 'VideoYacimiento.autory'
        db.delete_column('anarapp_videoyacimiento', 'autory')

        # Deleting field 'VideoYacimiento.instituciony'
        db.delete_column('anarapp_videoyacimiento', 'instituciony')

        # Deleting field 'VideoYacimiento.numReferenciay'
        db.delete_column('anarapp_videoyacimiento', 'numReferenciay')

        # Deleting field 'VideoYacimiento.isFromAnary'
        db.delete_column('anarapp_videoyacimiento', 'isFromAnary')

        # Deleting field 'VideoYacimiento.numCopiay'
        db.delete_column('anarapp_videoyacimiento', 'numCopiay')

        # Deleting field 'VideoYacimiento.archivoy'
        db.delete_column('anarapp_videoyacimiento', 'archivoy')

        # Deleting field 'VideoPiedra.isvidyac'
        db.delete_column('anarapp_videopiedra', 'isvidyac')

        # Deleting field 'VideoPiedra.anioy'
        db.delete_column('anarapp_videopiedra', 'anioy')

        # Deleting field 'VideoPiedra.formatoy'
        db.delete_column('anarapp_videopiedra', 'formatoy')

        # Deleting field 'VideoPiedra.tituloy'
        db.delete_column('anarapp_videopiedra', 'tituloy')

        # Deleting field 'VideoPiedra.autory'
        db.delete_column('anarapp_videopiedra', 'autory')

        # Deleting field 'VideoPiedra.instituciony'
        db.delete_column('anarapp_videopiedra', 'instituciony')

        # Deleting field 'VideoPiedra.numReferenciay'
        db.delete_column('anarapp_videopiedra', 'numReferenciay')

        # Deleting field 'VideoPiedra.isFromAnary'
        db.delete_column('anarapp_videopiedra', 'isFromAnary')

        # Deleting field 'VideoPiedra.numCopiay'
        db.delete_column('anarapp_videopiedra', 'numCopiay')

        # Deleting field 'VideoPiedra.archivoy'
        db.delete_column('anarapp_videopiedra', 'archivoy')

        # Adding field 'Video.anio'
        db.add_column('anarapp_video', 'anio',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Video.autor'
        db.add_column('anarapp_video', 'autor',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'Video.numReferencia'
        db.add_column('anarapp_video', 'numReferencia',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Video.archivo'
        db.add_column('anarapp_video', 'archivo',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Video.institucion'
        db.add_column('anarapp_video', 'institucion',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'Video.formato'
        db.add_column('anarapp_video', 'formato',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'Video.isFromAnar'
        db.add_column('anarapp_video', 'isFromAnar',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Video.numCopia'
        db.add_column('anarapp_video', 'numCopia',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Video.titulo'
        db.add_column('anarapp_video', 'titulo',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)
