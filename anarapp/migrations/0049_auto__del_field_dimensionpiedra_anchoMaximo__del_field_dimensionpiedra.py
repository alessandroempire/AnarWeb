...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DimensionPiedra.anchoMaximo'
        db.delete_column('anarapp_dimensionpiedra', 'anchoMaximo')

        # Deleting field 'DimensionPiedra.altoMaximo'
        db.delete_column('anarapp_dimensionpiedra', 'altoMaximo')

        # Deleting field 'DimensionPiedra.largoMaximo'
        db.delete_column('anarapp_dimensionpiedra', 'largoMaximo')

        # Adding field 'DimensionPiedra.alto'
        db.add_column('anarapp_dimensionpiedra', 'alto',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=6),
                      keep_default=False)

        # Adding field 'DimensionPiedra.largo'
        db.add_column('anarapp_dimensionpiedra', 'largo',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=6),
                      keep_default=False)

        # Adding field 'DimensionPiedra.ancho'
        db.add_column('anarapp_dimensionpiedra', 'ancho',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=6),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DimensionPiedra.anchoMaximo'
        db.add_column('anarapp_dimensionpiedra', 'anchoMaximo',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=6),
                      keep_default=False)

        # Adding field 'DimensionPiedra.altoMaximo'
        db.add_column('anarapp_dimensionpiedra', 'altoMaximo',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=6),
                      keep_default=False)

        # Adding field 'DimensionPiedra.largoMaximo'
        db.add_column('anarapp_dimensionpiedra', 'largoMaximo',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=6),
                      keep_default=False)

        # Deleting field 'DimensionPiedra.alto'
        db.delete_column('anarapp_dimensionpiedra', 'alto')

        # Deleting field 'DimensionPiedra.largo'
        db.delete_column('anarapp_dimensionpiedra', 'largo')

        # Deleting field 'DimensionPiedra.ancho'
        db.delete_column('anarapp_dimensionpiedra', 'ancho')
