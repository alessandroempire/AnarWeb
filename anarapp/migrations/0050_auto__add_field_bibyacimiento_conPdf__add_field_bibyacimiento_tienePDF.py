...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BibYacimiento.conPdf'
        db.add_column('anarapp_bibyacimiento', 'conPdf',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BibYacimiento.tienePDF'
        db.add_column('anarapp_bibyacimiento', 'tienePDF',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibYacimiento.tienePDF1'
        db.add_column('anarapp_bibyacimiento', 'tienePDF1',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibYacimiento.tienePDF2'
        db.add_column('anarapp_bibyacimiento', 'tienePDF2',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibYacimiento.conWord'
        db.add_column('anarapp_bibyacimiento', 'conWord',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BibYacimiento.tieneWord'
        db.add_column('anarapp_bibyacimiento', 'tieneWord',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibYacimiento.tieneWord1'
        db.add_column('anarapp_bibyacimiento', 'tieneWord1',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BibYacimiento.conPdf'
        db.delete_column('anarapp_bibyacimiento', 'conPdf')

        # Deleting field 'BibYacimiento.tienePDF'
        db.delete_column('anarapp_bibyacimiento', 'tienePDF')

        # Deleting field 'BibYacimiento.tienePDF1'
        db.delete_column('anarapp_bibyacimiento', 'tienePDF1')

        # Deleting field 'BibYacimiento.tienePDF2'
        db.delete_column('anarapp_bibyacimiento', 'tienePDF2')

        # Deleting field 'BibYacimiento.conWord'
        db.delete_column('anarapp_bibyacimiento', 'conWord')

        # Deleting field 'BibYacimiento.tieneWord'
        db.delete_column('anarapp_bibyacimiento', 'tieneWord')

        # Deleting field 'BibYacimiento.tieneWord1'
        db.delete_column('anarapp_bibyacimiento', 'tieneWord1')
