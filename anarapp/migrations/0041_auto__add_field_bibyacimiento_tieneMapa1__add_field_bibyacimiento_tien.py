...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BibYacimiento.tieneMapa1'
        db.add_column('anarapp_bibyacimiento', 'tieneMapa1',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibYacimiento.tieneMapa2'
        db.add_column('anarapp_bibyacimiento', 'tieneMapa2',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibYacimiento.tieneMapa3'
        db.add_column('anarapp_bibyacimiento', 'tieneMapa3',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibYacimiento.tieneMapa4'
        db.add_column('anarapp_bibyacimiento', 'tieneMapa4',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BibYacimiento.tieneMapa1'
        db.delete_column('anarapp_bibyacimiento', 'tieneMapa1')

        # Deleting field 'BibYacimiento.tieneMapa2'
        db.delete_column('anarapp_bibyacimiento', 'tieneMapa2')

        # Deleting field 'BibYacimiento.tieneMapa3'
        db.delete_column('anarapp_bibyacimiento', 'tieneMapa3')

        # Deleting field 'BibYacimiento.tieneMapa4'
        db.delete_column('anarapp_bibyacimiento', 'tieneMapa4')
    ...
    models = {
        ...
        'anarapp.bibyacimiento': {
            ...
            'tieneMapa1': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'tieneMapa2': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'tieneMapa3': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'tieneMapa4': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'tipoMapa': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'titulo': ('anarapp.models.CharField', [], {'max_length': '65000', 'blank': 'True'}),
