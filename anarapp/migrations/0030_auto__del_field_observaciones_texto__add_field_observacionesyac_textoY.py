...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Observaciones.texto'
        db.delete_column('anarapp_observaciones', 'texto')

        # Adding field 'ObservacionesYac.textoY'
        db.add_column('anarapp_observacionesyac', 'textoY',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'ObservacPiedra.textoP'
        db.add_column('anarapp_observacpiedra', 'textoP',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Observaciones.texto'
        db.add_column('anarapp_observaciones', 'texto',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Deleting field 'ObservacionesYac.textoY'
        db.delete_column('anarapp_observacionesyac', 'textoY')

        # Deleting field 'ObservacPiedra.textoP'
        db.delete_column('anarapp_observacpiedra', 'textoP')
