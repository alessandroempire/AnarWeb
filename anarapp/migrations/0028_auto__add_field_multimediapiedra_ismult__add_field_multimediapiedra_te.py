...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MultimediaPiedra.ismult'
        db.add_column('anarapp_multimediapiedra', 'ismult',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'MultimediaPiedra.tecnicaP'
        db.add_column('anarapp_multimediapiedra', 'tecnicaP',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'MultimediaPiedra.archivoP'
        db.add_column('anarapp_multimediapiedra', 'archivoP',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Multimedia.tecnica'
        db.delete_column('anarapp_multimedia', 'tecnica')

        # Deleting field 'Multimedia.archivo'
        db.delete_column('anarapp_multimedia', 'archivo')

        # Adding field 'MultimediaYac.ismult'
        db.add_column('anarapp_multimediayac', 'ismult',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'MultimediaYac.tecnicaY'
        db.add_column('anarapp_multimediayac', 'tecnicaY',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'MultimediaYac.archivoY'
        db.add_column('anarapp_multimediayac', 'archivoY',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MultimediaPiedra.ismult'
        db.delete_column('anarapp_multimediapiedra', 'ismult')

        # Deleting field 'MultimediaPiedra.tecnicaP'
        db.delete_column('anarapp_multimediapiedra', 'tecnicaP')

        # Deleting field 'MultimediaPiedra.archivoP'
        db.delete_column('anarapp_multimediapiedra', 'archivoP')

        # Adding field 'Multimedia.tecnica'
        db.add_column('anarapp_multimedia', 'tecnica',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'Multimedia.archivo'
        db.add_column('anarapp_multimedia', 'archivo',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'MultimediaYac.ismult'
        db.delete_column('anarapp_multimediayac', 'ismult')

        # Deleting field 'MultimediaYac.tecnicaY'
        db.delete_column('anarapp_multimediayac', 'tecnicaY')

        # Deleting field 'MultimediaYac.archivoY'
        db.delete_column('anarapp_multimediayac', 'archivoY')
